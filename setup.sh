...
tar -xvf public/webmail/roundcubemail-1.2.4-complete.tar.gz -C public/webmail

rm public/webmail/roundcubemail-1.2.4-complete.tar.gz

rsync -a public/webmail/roundcubemail-1.2.4/ public/webmail/

# mv public/webmail/roundcubemail-1.2.4/* public/webmail/
# mv public/webmail/roundcubemail-1.2.4/.* public/webmail/
